...
var Hcm_ProductSchema = mongoose.Schema({
        ...
        Product_Viscosity                           :Number,
        Product_Appearance                          :String,
        Product_Foriein_Matter                      :String,
        Product_Relative_Density_From               :Number,
        Product_Relative_Density_To                 :Number,
        Product_Bulk_Density_From                   :Number,
        Product_Bulk_Density_to                     :Number,
        Product_Relative_Index                      :Number,
        Product_Spescific_Opticical_Rotation        :String,
        Product_Specific_Surface_Area               :String,
        Product_Residue_On_Sieve                    :String,
        Product_Boiling_Point                       :Number,
        Product_Melting_Point                       :Number,
